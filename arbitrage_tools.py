...
def simulate(transfer_amount, asks, bids, exchange_rate=None):
    ...
    bitcoins = bitcoin_exchange(asks, euros - _kraken_fee, 'buy') #* 0.99
    ...
    print('Rands: %.2f' % capital)
    print('# forex conversion: %.2f' % float(_swift_fee + _fnb_comission))
    print('Euro: %.2f' % euros)
    print('# kraken fee: %.2f' % float((_kraken_fee + _kraken_deposit_fee) * exchange_rate ))
    print('Bitcoins: %.8f' % bitcoins)
    print('# bitx fee: %.2f' % float(_kraken_fee * exchange_rate))
    print('Rands: %.2f' % rands)
    print('--------------------')
    print('Profit: %.2f' % (return_value - capital))
    print('ROI: %.2f' % (((return_value - capital)/capital)*100))
    print('--------------------')
    print('BTC/ZAR: %.2f' % btc_zar_exchange_rate)
    print('ZAR/EUR: %.2f' % exchange_rate)
